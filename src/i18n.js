...
'settings.kicker':'SETTINGS','settings.title':'Game comfort','language':'Language','language.desc':'Choose the interface language.','volume':'Volume','volume.desc':'Master game sound volume.','sfx':'Sound effects','sfx.desc':'Shots, explosions and interface cues.','shake':'Screen shake','shake.desc':'Disabled by default for a more comfortable game.','autopause':'Auto pause','autopause.desc':'Pauses gameplay and sound when focus is lost.','on':'ON','off':'OFF',
'upgrade.kicker':'UPGRADE','upgrade.title':'Choose one upgrade','upgrade.desc':'One choice before the next wave.',
'result.kicker':'RESULT','next':'NEXT LEVEL','retry':'TRY AGAIN','map':'BATTLE MAP','points':'SCORE','wave':'WAVE','base':'BASE','tank':'TANK','targets':'TARGETS','fire':'FIRE','combo':'COMBO','perfect.short':'PERFECT',
